...
// async (dispatch, getState, api) automatically gets envoked by redux thunk - api argument refers to axiosInstance
...
// lets us use async/await syntax
var app = (0, _express2.default)(); // CommonJS modules - es2015 doesn't work unless it gets compiled by webpack/babel
...
var Header = function Header(_ref) {
	...
	// recieves prop 'auth' from redux store
...
var NotFoundPage = function NotFoundPage(_ref) {
  ...
  return _react2.default.createElement(
    'h1',
    { style: { width: '50%', margin: 'auto', marginTop: '200px', 'text-align': 'center' } },
